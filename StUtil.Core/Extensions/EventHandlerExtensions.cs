...
namespace StUtil.Extensions
{
    ...
    {
        /// <summary>
        /// Raises the event for a property changed event handler.
        /// </summary>
        ...
        /// <summary> Raise an event handler with a generic argument if it is not null </summary>
        /// <typeparam name="T">The type of the event handler</typeparam> <param name="handler">The
        /// handler to raise</param> <param name="sender">The sender of the event to pass to the
        /// handler raise</pa <param name="args">The value of the generic argument</param>
        ...
        /// <typeparam name="T">The type of the event handler</typeparam> <param name="handler">The
        /// handler to raise</param> <param name="sender">The sender of the event to pass to the
        /// handler raise</pa <param name="args">The value of the first generic argument</param>
        ...
        /// handler to raise</param> <param name="sender">The sender of the event to pass to the
        /// handler raise</pa <param name="args">The value of the first generic argument</param>
        /// <param name="arg2">The value of the second generic argument</param> <param
        /// name="arg3">The value of the third generic argument</param>
