...
namespace StUtil.Extensions
{
    ...
    {
        /// <summary>
        /// Determines whether a specified enumerable is a prefix of the current instance
        /// </summary>
        /// <typeparam name="TSource">The type of the items in the enumerable</typeparam>
        /// <param name="source">The source enumerable</param>
        /// <param name="match">The prefix to match</param>
        /// <returns>If the specified enumerable is a prefix of the current instance</returns>
        public static bool StartsWith<TSource>(this IEnumerable<TSource> source, IEnumerable<TSource> match)
        {
            return StartsWith(source, match, null);
        }
        ...
        /// <param name="source">The source enumerable</param>
        /// <param name="match">The prefix to match</param>
        /// <param name="comparer">The comparer to use to equate the items</param>
        /// <returns>If the specified enumerable is a prefix of the current instance</returns>
        public static bool StartsWith<TSource>(this IEnumerable<TSource> source, IEnumerable<TSource> match, IEqualityComparer<TSource> comparer)
        {
            if (comparer == null)
            {
            ...
            using (IEnumerator<TSource> e1 = match.GetEnumerator())
            {
                using (IEnumerator<TSource> e2 = source.GetEnumerator())
                {
                    while (e1.MoveNext())
                    {
        ...
        /// <summary>
        /// Determines whether a specified enumerable is a suffix of the current instance
        /// </summary>
        /// <typeparam name="TSource">The type of the items in the enumerable</typeparam>
        /// <param name="source">The source enumerable</param>
        /// <param name="match">The suffix to match</param>
        /// <returns>If the specified enumerable is a suffix of the current instance</returns>
        public static bool EndsWith<TSource>(this IEnumerable<TSource> source, IEnumerable<TSource> match)
        {
            return EndsWith(source, match, null);
        }
        ...
        /// <param name="comparer">The comparer to use to equate the items</param>
        /// <returns>If the specified enumerable is a suffix of the current instance</returns>
        public static bool EndsWith<TSource>(this IEnumerable<TSource> source, IEnumerable<TSource> match, IEqualityComparer<TSource> comparer)
        {
            return StartsWith(source.Reverse(), match.Reverse(), comparer);
        }
