...
namespace StUtil.Extensions
{
    ...
    {
        /// <summary>
        /// Draws a rounded rectangle specified by a pair of coordinates, a width, a height and the
        /// radius for the arcs that make the rounded edges.
        /// </summary>
        ...
        /// <summary>
        /// Fills the interior of a rounded rectangle specified by a pair of coordinates, a width, a
        /// height and the radius for the arcs that make the rounded edges.
        /// </summary>
        /// <param name="graphics">The graphics object used to draw</param>
        /// <param name="brush">
